clc;clear;
%% Fig5H - Contraction
image_frame         =   343;     plot_window_size = 250;
x_min = 420; x_max = x_min + plot_window_size;
y_min = 190; y_max = y_min + plot_window_size;
c_max = 0.05; c_min = -c_max;
image_output = 'Fig5H.png';
%% Fig5I - Expansion
% image_frame         =   939;     plot_window_size = 250;
% x_min = 460; x_max = x_min + plot_window_size;
% y_min = 160; y_max = y_min + plot_window_size;
% c_max = 0.05; c_min = -c_max;
% image_output = 'Fig5I.png';
%%
...
for count_t = image_frame
    ...
    div = divergence(xs_2D,ys_2D,dxs_2D,dys_2D);
    %%
    fig = figure(1);clf;
...
%%  plot the image overlaied with long axis and trajectories
    ...
    contourf(xs_2D,ys_2D,div,200, 'LineStyle','none'); axis equal; axis ij;
    load('cmap_divergence_2023-09-15.mat','mycmap');
